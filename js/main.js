...
<div class="social-container">
  ...
  <!-- item3 -->
        ...
        contactBtn.addEventListener("click", () => {
          ...
          const smallImg = document.querySelector('.small-card-img');
          const smallName = document.querySelector('.small-card-name');
          const smallLocation = document.querySelector('.small-card-location');

          smallImg.style.cssText = `background-image: url(${targetData.imgUrl})`;
          smallName.innerHTML = `${targetData.name}`;
          smallLocation.innerHTML = `${targetData.location}`;
